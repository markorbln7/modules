...
function useSelectedPaymentOptions() {
  const selectedPaymentOptions = subscription.useSubscription(api.useExtensionApi().selectedPaymentOptions);
  const availablePaymentOptions = subscription.useSubscription(api.useExtensionApi().availablePaymentOptions);
