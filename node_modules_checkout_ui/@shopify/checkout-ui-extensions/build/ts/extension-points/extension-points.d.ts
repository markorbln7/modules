...
export interface ExtensionPoints {
     ...
     */
    'Checkout::CustomerInformation::RenderAfter': RenderExtension<StandardApi<'Checkout::CustomerInformation::RenderAfter'>, AllComponents>;
    /**
     ...
     * @private
     */
    'Checkout::GiftCard::Render': RenderExtension<StandardApi<'Checkout::GiftCard::Render'>, AllComponents>;
    /**
     * A static extension point that renders the form fields for a payment method when selected by the buyer.
     *
     * @private
     */
    'Checkout::PaymentMethod::Render': RenderExtension<StandardApi<'Checkout::PaymentMethod::Render'>, AllComponents>;
    /**
     * A static extension point that renders a form modal when a buyer selects the custom onsite payment method.
     *
     * @private
     */
    'Checkout::PaymentMethod::RenderModal': RenderExtension<StandardApi<'Checkout::PaymentMethod::RenderModal'>, AllComponents>;
    /**
